            ...
            <div className=' h-screen bg-current'>
                ...
                <footer className=' py-12  bg-current absolute left-0 top-100 w-full'>
                    <div className='container mx-auto  my-12 pt-10 px-4'>
                        ...
                        <div className='flex md:flex-row flex-col px-2 py-2 mx-2 my-8 '>
                            <div className='mx-2 my-2'>
                                <div><a href="" className='text-slate-300 text-sm font-thin underline'>FAQ</a></div>
                                <div><a className='text-slate-300 text-sm font-thin underline' href="">Cookie Preference</a></div>
                                <div></div>
                            </div>
                            <div className='mx-2 my-2'>
                                <div><a className='text-slate-300 text-sm font-thin underline' href="">Help Center</a></div>
                                <div><a className='text-slate-300 text-sm font-thin underline' href="">Corporate Information</a></div>
                            </div>
                            <div className='mx-2 my-2'>
                                <div><a className='text-slate-300 text-sm font-thin underline' href="">Term of Use</a></div>
                            </div>
                            <div className='mx-2 my-2'>
                                <div><a className='text-slate-300 font-thin underline' href="">Privacy</a></div>
                            </div>
                        </div>
                    </div>
                </footer>
